...
Attention::Attention(std::map<std::string, std::string> commandlineArguments, cluon::OD4Session &od4, Drawer &drawer) :
    m_od4(od4)
  , m_cpcMutex()
  , m_CPCReceived(false)
  , m_pointCloud()
...
void Attention::ConeDetection(){
  ...
  m_drawer.setRANSACPoints(pcRefit);
